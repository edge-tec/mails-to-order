...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navMenu">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="/packages">Server Packages</a></li>
    ...
    <footer class="border-top border-secondary mt-5 py-4 text-center text-muted small">
        <div class="container">
            <p class="mb-1">&copy; <?= date('Y') ?> <?= htmlspecialchars(config('app.name')) ?>. All rights reserved.</p>
            <p class="mb-0"><a href="/terms" class="text-muted text-decoration-none me-3">Privacy & Terms</a> <a href="/contact" class="text-muted text-decoration-none">Support Desk</a></p>
        </div>
    </footer>
