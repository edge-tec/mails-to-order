...
<div class="row align-items-center py-5">
    <div class="col-lg-7">
        <span class="badge bg-primary bg-opacity-20 text-indigo px-3 py-2 rounded-pill mb-3">Enterprise Cloud & POP Infrastructure</span>
        <h1 class="display-4 fw-extrabold text-white mb-3">High Performance POP Server Ordering & Provisioning</h1>
        <p class="lead text-muted mb-4">Deploy optimized POP servers for automated operations, custom daily POP limits, and reliable message routing with instant credential delivery.</p>
    ...
    <div class="col-lg-5 text-center mt-5 mt-lg-0">
        <div class="card-custom p-4 shadow-lg border-indigo">
            <div class="p-3">
                ...
                <h4 class="text-white">POP Capacity Engine</h4>
                <p class="text-muted small">Configurable Daily 500 POP, 1,000 POP, and Enterprise subnets with AES-256-GCM encrypted credentials.</p>
                <div class="d-grid gap-2 mt-4">
                    <a href="/register" class="btn btn-outline-primary">Create Customer Account</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="mt-5">
    <div class="text-center mb-5">
        <h2 class="text-white font-weight-bold">Configured Server Packages</h2>
        <p class="text-muted">Choose your daily POP quota or request custom specifications</p>
    </div>
