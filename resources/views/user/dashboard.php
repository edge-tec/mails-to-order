...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted small mb-0">Overview of your active servers, POP quotas, and recent orders</p>
    </div>
...
<div class="row g-3 mb-4">
    <div class="col-md-3">
        <div class="card-custom p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <span class="text-muted small text-uppercase font-weight-bold">Active Servers</span>
                    <h3 class="text-white mb-0 mt-1"><?= $activeCount ?></h3>
                </div>
    ...
    <div class="col-md-3">
        <div class="card-custom p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <span class="text-muted small text-uppercase font-weight-bold">Total Orders</span>
                    <h3 class="text-white mb-0 mt-1"><?= count($orders) ?></h3>
                </div>
    ...
    <div class="col-md-3">
        <div class="card-custom p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <span class="text-muted small text-uppercase font-weight-bold">Daily POP Limit</span>
                    <h3 class="text-white mb-0 mt-1"><?= $popMetrics ? number_format($popMetrics['daily_limit']) : '—' ?></h3>
                </div>
    ...
    <div class="col-md-3">
        <div class="card-custom p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <span class="text-muted small text-uppercase font-weight-bold">Daily POP Remaining</span>
                    <h3 class="text-indigo mb-0 mt-1"><?= $popMetrics ? number_format($popMetrics['daily_remaining']) : '—' ?></h3>
                </div>
...
<?php if ($latestServer && $popMetrics): ?>
    <div class="card-custom p-4 mb-4 border-indigo">
        <h5 class="text-white mb-3"><i class="fa-solid fa-gauge-high text-indigo me-2"></i>Live POP Usage Tracking — Host: <?= htmlspecialchars($latestServer['host_ip']) ?></h5>
        <div class="row g-4">
            <div class="col-md-6">
                <div class="bg-dark p-3 rounded border border-secondary">
                    ...
                    <span class="text-muted small mt-2 d-block">Remaining Daily POP: <strong><?= number_format($popMetrics['daily_remaining']) ?></strong></span>
                </div>
            </div>
            <div class="col-md-6">
                <div class="bg-dark p-3 rounded border border-secondary">
                    ...
                    <span class="text-muted small mt-2 d-block">Remaining Monthly POP: <strong><?= number_format($popMetrics['monthly_remaining']) ?></strong></span>
                </div>
            </div>
        </div>
    </div>
...
<div class="card-custom p-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="text-white mb-0"><i class="fa-solid fa-receipt me-2"></i>Recent Orders</h5>
    ...
    <div class="table-responsive">
        <table class="table table-dark table-hover align-middle">
            ...
            <tbody>
                <?php if (empty($orders)): ?>
                    <tr><td colspan="6" class="text-center text-muted py-4">No orders placed yet. <a href="/packages">Order your first server</a></td></tr>
                <?php else: ?>
